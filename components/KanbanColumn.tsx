...
interface KanbanColumnProps {
    ...
    // Legacy/Optional props (ignored in favor of context, kept for compatibility)
    onUpdateTask?: any;
    activeTaskTimer?: any;
    onToggleTimer?: any;
    onDeleteTask?: any;
...
// Define specific tints for Space Mode
                            ...
                            <form onSubmit={handleQuickAddSubmit} className="flex gap-2">
                                <div className="relative flex-1">
                                    <input 
                                        ...
                                        className={`w-full px-3 py-1.5 ${isSupported ? 'pr-8' : ''} text-sm rounded-md border transition-all shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500
                                            ${isListening 
                        ...
                        {tasks.length === 0 ? (
                            ...
                            tasks.map((task) => (
                                <TaskCard
                                    ...
                                    onSubtaskToggle={(tid, sid) => {
                                        // Placeholder to satisfy interface, real logic handled inside TaskCard via Context
                                    }}
